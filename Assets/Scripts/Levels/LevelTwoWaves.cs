	...
	public new IEnumerator Start () {
		...
		waveManager.waves.Add(wave2Script);
				...
				wave4Script.units = new WaveUnit[] {
						new WaveUnit(allEnemies[0], 1, 0, 1, 2),
						new WaveUnit(allEnemies[0], 1, 0, 2, 2),
					};
				...
				wave5Script.units = new WaveUnit[] {
						new WaveUnit(allEnemies[0], 2f, 0, 1, 2),
						new WaveUnit(allEnemies[0], 2f, 0, 2, 3),
					};
				...
				bossWaveScript.units = new WaveUnit[] {
						new WaveUnit(allEnemies[1], 2f, 0, 3, 1),
						new WaveUnit(allEnemies[0], 2f, 0, 0, 1),
						new WaveUnit(allEnemies[0], 2f, 0, 1, 1),
						new WaveUnit(allEnemies[0], 2f, 0, 2, 1),
					};
