...
public class TestWaves : WaveScript {
	...
	public new IEnumerator Start () {
		...
		wave1Script.waveMode = Wave.WaveMode.EnemyDeathBased;
		...
		wave2Script.waveMode = Wave.WaveMode.EnemyDeathBased;
		...
		wave3Script.waveMode = Wave.WaveMode.TimeBased;
		wave3Script.nextWaveDelay = 30f;
		...
		wave4Script.waveMode = Wave.WaveMode.EnemyDeathBased;
		...
		wave5Script.waveMode = Wave.WaveMode.EnemyDeathBased;
